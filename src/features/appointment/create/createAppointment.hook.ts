...
export const useCreateAppointment = () => {
  ...
  const createAppointment = useMutation(async (appointment: CreateAppointmentFormData) => {
    try {
  ...
  return { formState, register, handleSubmit, handleCreateAppointment, active, setActive };
};
